...
const X64_SETUP =
  "github.com/elmokirk/handy-flow/releases/download/v0.9.5/Handy_0.9.5_x64-setup.exe";
const ARM64_SETUP =
  "github.com/elmokirk/handy-flow/releases/download/v0.9.5/Handy_0.9.5_arm64-setup.exe";
...
const manifest = {
  ...
  platforms: {
    ...
    "windows-x86_64-msi": {
      url: "github.com/elmokirk/handy-flow/releases/download/v0.9.5/Handy_0.9.5_x64_en-US.msi",
    },
    "windows-aarch64-nsis": { url: ARM64_SETUP, signature: "…" },
    "darwin-aarch64": {
      url: "github.com/elmokirk/handy-flow/releases/download/v0.9.5/Handy_aarch64.app.tar.gz",
    },
  },
};
